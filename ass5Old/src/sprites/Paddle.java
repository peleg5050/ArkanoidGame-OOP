...
/**
 * sprites.Paddle - The sprites.Paddle is the player in the game. It is a rectangle that is controlled by the arrow keys,
 ...
 * The sprites.Paddle also know how to move to the left and to the right (by using the timePassed method he check if the
...
public class Paddle implements Sprite, Collidable {
    ...
    public static final int X_MAX = Game.SIZE_OF_BOARD_X - 18;
