...
public class Velocity {
    ...
    /**
     * setDx - Set the dx value of the velocity (The change in the position on the `X` axes).
     *
     * @param newDx - New dx value of the velocity.
     */
    ...
    /**
     * setDy - Set the dy value of the velocity (The change in the position on the `Y` axes).
     *
     * @param newDy - New dy value of the velocity.
     */
