...
/**
 * Minus - The class represents a subtraction operation (subtraction two internal expressions and calculate them).
...
public class Minus extends BinaryExpression {
     ...
     * @return the result of the expression (calculate the subtraction of the two internal expressions).
    ...
    public double evaluate(Map<String, Double> assignment) throws Exception {
        // return the subtraction of the  two internal expressions
    ...
    public Expression assign(String var, Expression expression) {
        ...
        return new Minus(newExpression1, newExpression2);
    }
    ...
    public Expression differentiate(String var) {
        ...
        return new Minus(differentiate1, differentiate2);
    }
    ...
    public Expression simplify() {
        ...
        if (simplifyLeft.toString().equals("0.0")) {
            // Return the negative of the right expression
        ...
        // If the left expression or the right expression are different from 0 and different from each other
        // Return the expression without change
        // else...
        try {
            expressionMinus = (new Minus(simplifyLeft, simplifyRight)).evaluate();
            return new Num(expressionMinus);
        } catch (Exception exc) {
